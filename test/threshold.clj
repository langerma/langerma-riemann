(defn threshold-check-builder
  "Given a list of standard or inverted thresholds,
   yield a function that will adapt an inputs state.
...
(defn threshold-check
  "Given a map of threshold associating a service name with
   :warning and :critical values, yield a function that will adapt an event's
